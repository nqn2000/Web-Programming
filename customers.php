...
<head>
  ...
  <title>Baby Home Play : Customers</title>
  <!-- Bootstrap -->
...
<body style="background-image: url(bgBabyhomeplay3.png); background-size: 100%;">
  ...
  <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          <label for="custphone" class="col-sm-3 control-label">Phone Name</label>
          <div class="col-sm-9">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="address" type="text" class="form-control" id="custaddress" placeholder="Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_address']; ?>" required>
        </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      <table class="table table-striped table-bordered table-active" style="background-color: #FFE6BE">
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_customers_a173656_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      ?>
      <tr bgcolor="#FFE6BE">
        <td style="text-align: center" ><?php echo $readrow['fld_customer_num']; ?></td>
        <td><?php echo $readrow['fld_customer_name']; ?></td>
        <td style="text-align: center"><?php echo $readrow['fld_customer_phone']; ?></td>
